...
export default function profileForm() {
  const { firstName, lastName, email, photo, setField, setPhoto } = useProfileStore()
  ...
  return (
    ...
    >
     <div>
     <h2 className="text-3xl font-bold text-start text-gray-900">Profile Details</h2>
     <p className='text-[#737373] text-[16px] mt-0.5'>Add your details to create a personal touch to your profile.</p>
     </div>
